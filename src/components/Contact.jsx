  ...
  return (
    <div className="border-b border-neutral-900 pb-20">
      ...
      <div className="text-center tracking-tighter">
        <motion.p  whileInView={{opacity:1,x:0}} initial={{opacity:0,x:-100}} transition={{duration:1.5}} className="text-lg text-neutral-400">{CONTACT.address}</motion.p>
        <motion.p whileInView={{opacity:1,x:0}} initial={{opacity:0,x:100}} transition={{duration:1.5}} className="text-lg text-neutral-400">{CONTACT.phoneNo}</motion.p>
        <a href={`mailto:${CONTACT.email}`} className="text-lg text-neutral-400 border-b">
          {CONTACT.email}
        </a>

        <motion.div whileInView={{opacity:1,y:0}} initial={{opacity:0,y:100}} transition={{duration:1.5}} className="flex justify-center gap-4 text-2xl text-white py-10">
